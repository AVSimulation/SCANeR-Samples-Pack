...
<sce version="20.21.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  ...
  <Scenario>
    ...
    <PredefinedRun>
      <type>21</type>
      <StraightLineSSRun>
        <finalSpeed>22.2222222222222</finalSpeed>
        <gearMode>0</gearMode>
        <gearRatioFrom>1</gearRatioFrom>
        <gearRatioTo>2</gearRatioTo>
        <initialSpeed>2.77777777777778</initialSpeed>
        <passagerNumberFrom>0</passagerNumberFrom>
        <passagerNumberTo>0</passagerNumberTo>
        <speedIncr>2.77777777777778</speedIncr>
        <strategy>0</strategy>
        <windAzimuth>0</windAzimuth>
        <windSpeed>0</windSpeed>
      </StraightLineSSRun>
      <NetTractionRun>
        <command>0</command>
        <finalDistance>20000</finalDistance>
        <finalTime>3600</finalTime>
        <gearMode>0</gearMode>
        <gearRatioFrom>1</gearRatioFrom>
        <gearRatioTo>4</gearRatioTo>
        <initialForce>0</initialForce>
        <initialSpeed>13.8888888888889</initialSpeed>
        <isEarthReferentialForce>0</isEarthReferentialForce>
        <isFixedSteering>0</isFixedSteering>
        <minSpeed>0.277777777777778</minSpeed>
        <netTractionInc>1000</netTractionInc>
        <netTractionPointDistance>5</netTractionPointDistance>
        <netTractionPointHeight>0.5</netTractionPointHeight>
        <netTractionSpeed>50</netTractionSpeed>
        <openningPedalGas>1</openningPedalGas>
        <signalType>0</signalType>
        <stabilizedTime>0.1</stabilizedTime>
        <stabilizedTimeMax>15</stabilizedTimeMax>
        <strategy>1</strategy>
        <tireUtilizationRate>1</tireUtilizationRate>
      </NetTractionRun>
      <BrakingDynRun>
        <banking>0</banking>
        <brakingAscendingTime>1</brakingAscendingTime>
        <brakingForce>400</brakingForce>
        <brakingType>0</brakingType>
        <decelaration>3</decelaration>
        <declutched>0</declutched>
        <derivationLimite>0.174532925199433</derivationLimite>
        <finalDistance>100</finalDistance>
        <finalTime>20</finalTime>
        <gearMode>0</gearMode>
        <gearRatioFrom>1</gearRatioFrom>
        <gearRatioTo>2</gearRatioTo>
        <initialSpeed>22.2222222222222</initialSpeed>
        <isABSActive>1</isABSActive>
        <isDriverControl>0</isDriverControl>
        <isRegulateBrakPedal>0</isRegulateBrakPedal>
        <isStopDerivation>0</isStopDerivation>
        <isStopSpinning>1</isStopSpinning>
        <minSpeed>1.38888888888889</minSpeed>
        <signal>0</signal>
        <slope>0</slope>
        <strategy>0</strategy>
        <windAzimuth>0</windAzimuth>
      ...
      <JTurnRun>
        <accelPosition>0.5</accelPosition>
        <angularSpeed>1.74532925199433</angularSpeed>
        <declutched>0</declutched>
        <finalTime>10</finalTime>
        <initialSpeed>22.2222222222222</initialSpeed>
        <isConstantSpeed>1</isConstantSpeed>
        <isLeft>1</isLeft>
        <isStopSpinning>0</isStopSpinning>
        <maxSteeringWheel>1.74532925199433</maxSteeringWheel>
        <signal>0</signal>
        <stopStableMovement>0</stopStableMovement>
      </JTurnRun>
      <FishHookRun>
        <TypeFishHook>0</TypeFishHook>
        <finalDistance>200</finalDistance>
        <finalTime>10</finalTime>
        <gearRatio>4</gearRatio>
        <increasedSpeed>0.277777777777778</increasedSpeed>
        <isLeftSteering>1</isLeftSteering>
        <isStopOnLift>1</isStopOnLift>
        <isStopOnRollAngle>0</isStopOnRollAngle>
        <isStopSpinning>1</isStopSpinning>
        <maneuverBeginningSpeed>22.2222222222222</maneuverBeginningSpeed>
        <rollAngle>1.39626340159546</rollAngle>
        <rollSpeedCriteria>0</rollSpeedCriteria>
        <stabilizedTimeCounterSteering>3</stabilizedTimeCounterSteering>
        <steeringAmplitude>0.872664625997165</steeringAmplitude>
        <steeringSpeed>12.5663706143592</steeringSpeed>
        <steeringWheelReturnTime>2</steeringWheelReturnTime>
      </FishHookRun>
      <ChicaneRun>
    ...
    <Vehicle>
      ...
      <modelName>SmallFamilyCar.tmp.ladm</modelName>
      <motionId>-1</motionId>
      <name>target</name>
