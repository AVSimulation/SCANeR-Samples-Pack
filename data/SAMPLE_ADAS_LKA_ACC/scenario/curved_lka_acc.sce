...
The camera sensor model used is: FrontCamera_Lanes_Lines</description>
    ...
    <Ground>
      ...
      <name>long_curve_highway.rnd</name>
...
TYPEOF SCENARIO (0)
{
    ...
    <Vehicle>
      ...
      <ObjectPosition>
        <heading>0</heading>
        <position>-5.99520433297585e-15 -1.74999999996894 0</position>
        <IntersectionPosition>
          <intersection>Intersection</intersection>
          <relativeHeading>0</relativeHeading>
          <relativePosition>0.556435406208032 -1.73414353836947 0</relativePosition>
    ...
    <Vehicle>
      ...
      <ObjectPosition>
        <heading>0</heading>
        <position>9.99950840773298 -1.74996772697758 0</position>
        <RoadPosition>
          <abscissa>6272.01829136115</abscissa>
          <gapInItnSystem>-1.79987423107671</gapInItnSystem>
          <relativeHeading>3.13161087036133</relativeHeading>
          <subNetwork>Sub Network</subNetwork>
          <track>Track 1</track>
          <zOffset>0</zOffset>
        </RoadPosition>
