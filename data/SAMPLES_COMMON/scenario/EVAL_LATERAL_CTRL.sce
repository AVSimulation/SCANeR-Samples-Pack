...
The camera sensor model used is: FrontCamera_Lanes_Lines</description>
    ...
    <Vehicle>
      ...
      <Equipments>
        <sensorConfigurationName>markingDetection</sensorConfigurationName>
        <SensorOutputProcs>
          ...
          <OutputProc>
            <outputName>sensorPolynom</outputName>
            <processName>Automatic</processName>
          </OutputProc>
          <OutputProc>
      ...
      <ObjectPosition>
        <heading>0.000461254589026794</heading>
        <position>-78.1526707824286 98.5116186098824 0</position>
        <RoadPosition>
          <abscissa>45.6250537284311</abscissa>
          <gapInItnSystem>-3.42499466288171e-15</gapInItnSystem>
