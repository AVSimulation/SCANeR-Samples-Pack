...
<sce version="1.9.1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">

  <Scenario>
    <description>-------------------------------------
Scenario: This scenario is identical to the scenario "EVAL_ADAS_CTRL".
This scenario must be used with the NON REAL TIME (NRT) configuration "EVAL_NRT_16".
It demonstrates the usage of the OFFLINESCHEDULER module.
The OFFLINESCHEDULER is used to precisely control the execution of modules in a non-realtime execution. The OFFLINESCHEDULER executes the modules in a precise order, defined with priority order. Moreover, OFFLINESCHEDULER gives others module precise timesteps depending on their frequency. This allows the simulation to run in a non-realtime way, as fast as possible. 
-------------------------------------
Needed modules:
OFFLINESCHEDULER, ACQUISITION, MODELHANDLER, SCENARIO, SENSORS, WALKERTRAFFIC
+
LONGI_C.
-------------------------------------</description>
    <name></name>
...
TYPEOF SCENARIO (0)
{
	...
	TYPEOF VARIABLE (0)
	{
		...
		INTERACTIVE_MIN_VALUE="0.5"
		INTERACTIVE_MAX_VALUE="20"
		INTERACTIVE_STEP_VALUE="0.5"
		CATEGORY="INTERNAL"
	}
	...
	TYPEOF RULE (1)
	{
		LABEL="Rule: distanceToCollision"
    ...
    <Vehicle>
      ...
      <Equipments>
        ...
        <SensorOutputProcs>
          ...
          <OutputProc>
            <outputName>sensorTarget</outputName>
